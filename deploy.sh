...
docker tag jtwebman/node-express-postgres-docker-todo "jtwebman/node-express-postgres-docker-todo:build-$TRAVIS_BUILD_NUMBER"
...
docker push "jtwebman/node-express-postgres-docker-todo:build-$TRAVIS_BUILD_NUMBER"
